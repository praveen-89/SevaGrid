              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {['LOW', 'MEDIUM', 'HIGH', 'URGENT'].map((p) => (
                  <Button
                    ...
                    className={formData.severity === p ? 'bg-indigo-600' : ''}
      ...
      case 3:
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="aspect-video bg-slate-100 rounded-xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 gap-2">
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-2">
              ...
              <div className="border-2 border-dashed border-slate-200 rounded-xl p-8 flex flex-col items-center justify-center text-slate-400 hover:border-indigo-400 hover:bg-slate-50 transition-all cursor-pointer">
      ...
      case 5:
        return (
          <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
            <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-100 flex gap-3 text-indigo-800">
      ...
      <div className="max-w-3xl mx-auto space-y-8 pb-20">
        ...
        <div className="space-y-4">
           <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm font-bold text-slate-400 uppercase tracking-widest">Step {currentStep} of 5</span>
           </div>
           <Progress value={(currentStep / 5) * 100} className="h-2 bg-slate-100" />
              ...
              {STEPS.map((step) => (
                ...
                >
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all ${
                    step.id === currentStep ? 'border-indigo-600 bg-indigo-50' : 
                    step.id < currentStep ? 'border-emerald-500 bg-emerald-50' : 'border-slate-200'
                  }`}>
        ...
        <Card className="border-none shadow-xl shadow-slate-200/50">
           ...
           <CardFooter className="flex justify-between border-t border-slate-100 pt-6">
              ...
              {currentStep < 5 ? (
                <Button onClick={nextStep} className="bg-indigo-600 hover:bg-indigo-700 min-w-[120px]">
